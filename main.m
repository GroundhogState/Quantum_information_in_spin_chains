...
% Add: Spectral embeddings
    ...
    % Higher eigenvalues/ratios thereof. Compare to partitions results with
    % new H?
...
% Tonight: 
    % Finish W trends for L analysis
        % Spectral power ratios; sum of weights; spectral embeddings; 
    % Try fast-trace
