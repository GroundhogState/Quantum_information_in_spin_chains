function proc_data = system_proc_13(net_data,config)
...
config.viz.fid=1;
config.viz.fig_title = 'Weight distribution 13';
...
config.viz.log_scale = 1;
config.viz.fid=2;
config.viz.fig_title='Degree distribution  13';
...
config.viz.log_scale = 1;
config.viz.fid=11;
config.viz.fig_title='Aleph spectral distribution  13';
...
config.viz.log_scale = 1;
config.viz.fid=12;
config.viz.fig_title='Laplacian spectral distribution 13';
...
config.viz.log_scale = 1;
config.viz.fid=21;
config.viz.fig_title='Aleph trace distribution 13';
...
config.viz.log_scale = 1;
config.viz.fid=22;
config.viz.fig_title='Laplacian trace distribution 13';
...
config.viz.fig_title = 'VN Entropy distribution 13';
config.viz.fid=31;
