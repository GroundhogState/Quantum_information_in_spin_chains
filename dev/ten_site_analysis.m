function proc_data = ten_site_analysis(net_data,config)
...
config.viz.fid=1;
config.viz.fig_title = 'Weight distribution';
...
config.viz.log_scale = 1;
config.viz.fid=2;
config.viz.fig_title='Degree distribution';
...
config.viz.log_scale = 1;
config.viz.fid=11;
config.viz.fig_title='Aleph spectral distribution';
...
config.viz.log_scale = 1;
config.viz.fid=12;
config.viz.fig_title='Laplacian spectral distribution';
...
config.viz.log_scale = 1;
config.viz.fid=21;
config.viz.fig_title='Aleph trace distribution';
...
config.viz.log_scale = 1;
config.viz.fid=22;
config.viz.fig_title='Laplacian trace distribution';
...
config.viz.fig_title = 'VN Entropy distribution';
config.viz.fid=31;
